...
VOLUNTARYCHECK=0
I=1
BOT=TH3_BOSS # You can put here other bots. Also you can change it to run more than one bot in the same server.
...
echo -e "               \e[01;34m         DEV >   @TH3BOSS            \e[00;37;40m"
echo ""
cat << EOF
...
echo -e "\033[38;5;208m             BY мσнαммє∂ нιѕнαм ll99Kll    \033[0;00m"
